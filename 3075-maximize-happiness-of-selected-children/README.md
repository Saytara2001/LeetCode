...
<pre style="position: relative;"><strong>Input:</strong> happiness = [1,2,3], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> happiness = [1,1,1,1], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> happiness = [2,3,4,5], k = 1
